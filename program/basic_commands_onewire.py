...
# чтение адреса отп одной ячейки. НЕ ПРОВЕРЕНА В РАБОТЕ
...
# Записать REZ. НЕ ПРОВЕРЕНА В РАБОТЕ
...
# Запись памяти ОТП. НЕ ПРОВЕРЕНА В РАБОТЕ
...
# Запись коэффициентов К и В. НЕ ПРОВЕРЕНА В РАБОТЕ
...
# записать EN2 (переводит работу микросхему на память ОТП) НЕ ПРОВЕРЕНА В РАБОТЕ
...
# Запись памяти в новый микрос с OneWire интерфейсом
...
# Чтение паяти микросхем. Для нового микроса с  OneWire интерфейсом
