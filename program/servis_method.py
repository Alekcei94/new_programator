...
def test_crc(data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7):
    list_Test = [data_0, data_1, data_2, data_3, data_4, data_5, data_6, data_7]
    crc8Table = [
...
def pr(ser, claster, number):
    ...
    #     write_commands(ser, claster, number, 165, 3)  # A5 задержка 60мС
    #     write_commands(ser, claster, number, 169, 0)  # A9 опустить линию PR
    #     write_commands(ser, claster, number, 165, 6)  # A5 задержка 120мС
